...
class Session(Base):
    """Session model matching Google ADK DatabaseSessionService schema.

    The ADK expects composite PK (app_name, user_id, id) for sessions table.
    This model is read-only - the ADK manages table creation and data.
    """
