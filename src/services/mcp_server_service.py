...
def create_mcp_server(db: Session, server: MCPServerCreate) -> MCPServer:
    ...
    try:
        ...
        if not supplied_tools:
            ...
            # supplied_tools is already a list of dicts from model_dump()
            server_data["tools"] = supplied_tools
...
def update_mcp_server(
    ...
    try:
        ...
        # Convert tools to JSON serializable format
        server_data = server.model_dump()
        # tools are already dicts from model_dump(), no need to convert again
