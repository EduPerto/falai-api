...
# Import condicional para crewai (dependência opcional)
try:
    from src.services.crewai.session_service import CrewSessionService
    CREWAI_AVAILABLE = True
except ImportError:
    CrewSessionService = None
    CREWAI_AVAILABLE = False

if os.getenv("AI_ENGINE") == "crewai" and CREWAI_AVAILABLE:
    session_service = CrewSessionService(db_url=os.getenv("POSTGRES_CONNECTION_STRING"))
else:
    # O DatabaseSessionService precisa de driver asyncpg
